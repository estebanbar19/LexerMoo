...
funcionStatement -> %tipoVariable (espacioEnBlanco | null) %lcorch (espacioEnBlanco | null) argumentos (espacioEnBlanco | null) %rcorch (espacioEnBlanco | null) %string (espacioEnBlanco | null) %lbracket (%NL | %WS):* statements (%NL | %WS):* %rbracket (espacioEnBlanco | null) (findelinea | null) {% (d) => 'function '+d[8]+'('+d[4]+'){\n'+d[12]+'\n}' %} 
        ...
        | %tipoVariable (espacioEnBlanco | null) %lcorch (espacioEnBlanco | null) %rcorch (espacioEnBlanco | null) %string (espacioEnBlanco | null) %lbracket (%NL | %WS):* statements (%NL | %WS):* %rbracket (espacioEnBlanco | null) (findelinea | null) {% (d) => 'function '+d[6]+'(){\n'+d[10]+'\n}' %} 
        | %tipoVariable (espacioEnBlanco | null) %lcorch (espacioEnBlanco | null) %rcorch (espacioEnBlanco | null) %string (espacioEnBlanco | null) %lbracket (%NL | %WS):* %rbracket (espacioEnBlanco | null) (findelinea | null) {% (d) => 'function '+d[6]+'(){}' %}
