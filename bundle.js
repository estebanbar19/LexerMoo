...
var grammar = {
    ...
    {"name": "imp$subexpression$2", "symbols": [(lexer.has("number") ? {type: "number"} : number)]},
    {"name": "imp$subexpression$2", "symbols": ["numberDecimal"]},
    {"name": "imp", "symbols": ["imp$subexpression$2"], "postprocess": (d) => '('+d[0]+')'},
    ...
    {"name": "operacion", "symbols": ["operacion$subexpression$1", "operacion$subexpression$2", {"literal":"+"}, "operacion$subexpression$3", "operacion$subexpression$4"], "postprocess": (d) => ''+d[0]+'+'+d[4]+''},
    ...
    {"name": "operacion", "symbols": ["operacion$subexpression$5", "operacion$subexpression$6", {"literal":"-"}, "operacion$subexpression$7", "operacion$subexpression$8"], "postprocess": (d) => ''+d[0]+'-'+d[4]+''},
    ...
    {"name": "operacion", "symbols": ["operacion$subexpression$9", "operacion$subexpression$10", {"literal":"*"}, "operacion$subexpression$11", "operacion$subexpression$12"], "postprocess": (d) => ''+d[0]+'*'+d[4]+''},
    ...
    {"name": "operacion", "symbols": ["operacion$subexpression$13", "operacion$subexpression$14", {"literal":"/"}, "operacion$subexpression$15", "operacion$subexpression$16"], "postprocess": (d) => ''+d[0]+'/'+d[4]+''},
    ...
    {"name": "operacionlogica", "symbols": ["operacionlogica$subexpression$1", "operacionlogica$subexpression$2", {"literal":"mayorQue"}, "operacionlogica$subexpression$3", "operacionlogica$subexpression$4", "operacionlogica$subexpression$5"], "postprocess": (d) => ''+d[0]+'>'+d[4]+''},
    {"name": "operacionlogica$subexpression$6", "symbols": [(lexer.has("string") ? {type: "string"} : string)]},
    {"name": "operacionlogica$subexpression$6", "symbols": [(lexer.has("number") ? {type: "number"} : number)]},
    {"name": "operacionlogica$subexpression$6", "symbols": ["numberDecimal"]},
    ...
    {"name": "operacionlogica$subexpression$9$subexpression$1", "symbols": [(lexer.has("string") ? {type: "string"} : string)]},
    {"name": "operacionlogica$subexpression$9$subexpression$1", "symbols": [(lexer.has("number") ? {type: "number"} : number)]},
    {"name": "operacionlogica$subexpression$9$subexpression$1", "symbols": ["numberDecimal"]},
    {"name": "operacionlogica$subexpression$9", "symbols": ["operacionlogica$subexpression$9$subexpression$1"]},
    {"name": "operacionlogica$subexpression$9", "symbols": ["operacionlogica"]},
    {"name": "operacionlogica$subexpression$10", "symbols": ["espacioEnBlanco"]},
    {"name": "operacionlogica$subexpression$10", "symbols": []},
    {"name": "operacionlogica", "symbols": ["operacionlogica$subexpression$6", "operacionlogica$subexpression$7", {"literal":"menorQue"}, "operacionlogica$subexpression$8", "operacionlogica$subexpression$9", "operacionlogica$subexpression$10"], "postprocess": (d) => ''+d[0]+'<'+d[4]+''},
    {"name": "operacionlogica$subexpression$11", "symbols": [(lexer.has("string") ? {type: "string"} : string)]},
    {"name": "operacionlogica$subexpression$11", "symbols": [(lexer.has("number") ? {type: "number"} : number)]},
    {"name": "operacionlogica$subexpression$11", "symbols": ["numberDecimal"]},
    {"name": "operacionlogica$subexpression$12", "symbols": ["espacioEnBlanco"]},
    {"name": "operacionlogica$subexpression$12", "symbols": []},
    {"name": "operacionlogica$subexpression$13", "symbols": ["espacioEnBlanco"]},
    {"name": "operacionlogica$subexpression$13", "symbols": []},
    {"name": "operacionlogica$subexpression$14$subexpression$1", "symbols": [(lexer.has("string") ? {type: "string"} : string)]},
    {"name": "operacionlogica$subexpression$14$subexpression$1", "symbols": [(lexer.has("number") ? {type: "number"} : number)]},
    {"name": "operacionlogica$subexpression$14$subexpression$1", "symbols": ["numberDecimal"]},
    {"name": "operacionlogica$subexpression$14", "symbols": ["operacionlogica$subexpression$14$subexpression$1"]},
    {"name": "operacionlogica$subexpression$14", "symbols": ["operacionlogica"]},
    {"name": "operacionlogica$subexpression$15", "symbols": ["espacioEnBlanco"]},
    {"name": "operacionlogica$subexpression$15", "symbols": []},
    {"name": "operacionlogica", "symbols": ["operacionlogica$subexpression$11", "operacionlogica$subexpression$12", {"literal":"mayorIgualQue"}, "operacionlogica$subexpression$13", "operacionlogica$subexpression$14", "operacionlogica$subexpression$15"], "postprocess": (d) => ''+d[0]+'>='+d[4]+''},
    {"name": "operacionlogica$subexpression$16", "symbols": [(lexer.has("string") ? {type: "string"} : string)]},
    {"name": "operacionlogica$subexpression$16", "symbols": [(lexer.has("number") ? {type: "number"} : number)]},
    {"name": "operacionlogica$subexpression$16", "symbols": ["numberDecimal"]},
    ...
    {"name": "operacionlogica$subexpression$19$subexpression$1", "symbols": [(lexer.has("string") ? {type: "string"} : string)]},
    {"name": "operacionlogica$subexpression$19$subexpression$1", "symbols": [(lexer.has("number") ? {type: "number"} : number)]},
    {"name": "operacionlogica$subexpression$19$subexpression$1", "symbols": ["numberDecimal"]},
    {"name": "operacionlogica$subexpression$19", "symbols": ["operacionlogica$subexpression$19$subexpression$1"]},
    {"name": "operacionlogica$subexpression$19", "symbols": ["operacionlogica"]},
    {"name": "operacionlogica$subexpression$20", "symbols": ["espacioEnBlanco"]},
    {"name": "operacionlogica$subexpression$20", "symbols": []},
    {"name": "operacionlogica", "symbols": ["operacionlogica$subexpression$16", "operacionlogica$subexpression$17", {"literal":"menorIgualQue"}, "operacionlogica$subexpression$18", "operacionlogica$subexpression$19", "operacionlogica$subexpression$20"], "postprocess": (d) => ''+d[0]+'<='+d[4]+''},
    ...
    {"name": "operacionlogica$subexpression$21", "symbols": ["numberDecimal"]},
    ...
    {"name": "operacionlogica$subexpression$24$subexpression$1", "symbols": ["numberDecimal"]},
    ...
    {"name": "operacionlogica$subexpression$25", "symbols": ["espacioEnBlanco"]},
    {"name": "operacionlogica$subexpression$25", "symbols": []},
    {"name": "operacionlogica", "symbols": ["operacionlogica$subexpression$21", "operacionlogica$subexpression$22", {"literal":"igualQue"}, "operacionlogica$subexpression$23", "operacionlogica$subexpression$24", "operacionlogica$subexpression$25"], "postprocess": (d) => ''+d[0]+'=='+d[4]+''},
    {"name": "operacionlogica$subexpression$26", "symbols": [(lexer.has("string") ? {type: "string"} : string)]},
    {"name": "operacionlogica$subexpression$26", "symbols": [(lexer.has("number") ? {type: "number"} : number)]},
    {"name": "operacionlogica$subexpression$26", "symbols": ["numberDecimal"]},
    {"name": "operacionlogica$subexpression$27", "symbols": ["espacioEnBlanco"]},
    {"name": "operacionlogica$subexpression$27", "symbols": []},
    {"name": "operacionlogica$subexpression$28", "symbols": ["espacioEnBlanco"]},
    {"name": "operacionlogica$subexpression$28", "symbols": []},
    {"name": "operacionlogica$subexpression$29$subexpression$1", "symbols": [(lexer.has("string") ? {type: "string"} : string)]},
    {"name": "operacionlogica$subexpression$29$subexpression$1", "symbols": [(lexer.has("number") ? {type: "number"} : number)]},
    {"name": "operacionlogica$subexpression$29$subexpression$1", "symbols": ["numberDecimal"]},
    {"name": "operacionlogica$subexpression$29", "symbols": ["operacionlogica$subexpression$29$subexpression$1"]},
    {"name": "operacionlogica$subexpression$29", "symbols": ["operacionlogica"]},
    {"name": "operacionlogica$subexpression$30", "symbols": ["espacioEnBlanco"]},
    {"name": "operacionlogica$subexpression$30", "symbols": []},
    {"name": "operacionlogica", "symbols": ["operacionlogica$subexpression$26", "operacionlogica$subexpression$27", {"literal":"diferenteQue"}, "operacionlogica$subexpression$28", "operacionlogica$subexpression$29", "operacionlogica$subexpression$30"], "postprocess": (d) => ''+d[0]+'!='+d[4]+''},
    ...
    {"name": "operacionCorta", "symbols": ["operacionCorta$subexpression$1", {"literal":"_mas mas"}, "operacionCorta$subexpression$2"], "postprocess": (d) => ''+d[0]+'+=1'},
    {"name": "operacionCorta$subexpression$3", "symbols": [(lexer.has("string") ? {type: "string"} : string)]},
    {"name": "operacionCorta$subexpression$3", "symbols": [(lexer.has("number") ? {type: "number"} : number)]},
    {"name": "operacionCorta$subexpression$4", "symbols": ["espacioEnBlanco"]},
    {"name": "operacionCorta$subexpression$4", "symbols": []},
    {"name": "operacionCorta", "symbols": ["operacionCorta$subexpression$3", {"literal":"_menos menos"}, "operacionCorta$subexpression$4"], "postprocess": (d) => ''+d[0]+'-=1'},
