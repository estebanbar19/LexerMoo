...
var grammar = {
    ...
    {"name": "argumentos", "symbols": ["argumento"]},
    ...
    {"name": "argumentos", "symbols": ["argumentos", "argumentos$subexpression$1", {"literal":","}, "argumentos$subexpression$2", "argumento"], "postprocess": (d) => ''+d[0]+','+d[1]+''},
    {"name": "argumento$ebnf$1", "symbols": []},
    {"name": "argumento$ebnf$1", "symbols": ["argumento$ebnf$1", (lexer.has("number") ? {type: "number"} : number)], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "argumento", "symbols": [(lexer.has("string") ? {type: "string"} : string), "argumento$ebnf$1"]},
