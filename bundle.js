...
var grammar = {
    ...
    {"name": "input$ebnf$1$subexpression$1", "symbols": [(lexer.has("NL") ? {type: "NL"} : NL)]},
    {"name": "input$ebnf$1$subexpression$1", "symbols": [(lexer.has("WS") ? {type: "WS"} : WS)]},
    ...
    {"name": "ifStatement$ebnf$5$subexpression$1", "symbols": [(lexer.has("NL") ? {type: "NL"} : NL)]},
    {"name": "ifStatement$ebnf$5$subexpression$1", "symbols": [(lexer.has("WS") ? {type: "WS"} : WS)]},
    {"name": "ifStatement$ebnf$5", "symbols": ["ifStatement$ebnf$5", "ifStatement$ebnf$5$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    ...
    {"name": "ifStatement$ebnf$6$subexpression$1", "symbols": [(lexer.has("NL") ? {type: "NL"} : NL)]},
    {"name": "ifStatement$ebnf$6$subexpression$1", "symbols": [(lexer.has("WS") ? {type: "WS"} : WS)]},
    {"name": "ifStatement$ebnf$6", "symbols": ["ifStatement$ebnf$6", "ifStatement$ebnf$6$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    ...
    {"name": "whileStatement$ebnf$3$subexpression$1", "symbols": [(lexer.has("NL") ? {type: "NL"} : NL)]},
    {"name": "whileStatement$ebnf$3$subexpression$1", "symbols": [(lexer.has("WS") ? {type: "WS"} : WS)]},
    {"name": "whileStatement$ebnf$3", "symbols": ["whileStatement$ebnf$3", "whileStatement$ebnf$3$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    ...
    {"name": "doWhileStatement$ebnf$3$subexpression$1", "symbols": [(lexer.has("NL") ? {type: "NL"} : NL)]},
    {"name": "doWhileStatement$ebnf$3$subexpression$1", "symbols": [(lexer.has("WS") ? {type: "WS"} : WS)]},
    {"name": "doWhileStatement$ebnf$3", "symbols": ["doWhileStatement$ebnf$3", "doWhileStatement$ebnf$3$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    ...
    {"name": "forStatement$ebnf$3$subexpression$1", "symbols": [(lexer.has("NL") ? {type: "NL"} : NL)]},
    {"name": "forStatement$ebnf$3$subexpression$1", "symbols": [(lexer.has("WS") ? {type: "WS"} : WS)]},
    {"name": "forStatement$ebnf$3", "symbols": ["forStatement$ebnf$3", "forStatement$ebnf$3$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    ...
    {"name": "funcionStatement$ebnf$1$subexpression$1", "symbols": [(lexer.has("NL") ? {type: "NL"} : NL)]},
    {"name": "funcionStatement$ebnf$1$subexpression$1", "symbols": [(lexer.has("WS") ? {type: "WS"} : WS)]},
    {"name": "funcionStatement$ebnf$1", "symbols": ["funcionStatement$ebnf$1", "funcionStatement$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    ...
    {"name": "funcionStatement$ebnf$3$subexpression$1", "symbols": [(lexer.has("NL") ? {type: "NL"} : NL)]},
    {"name": "funcionStatement$ebnf$3$subexpression$1", "symbols": [(lexer.has("WS") ? {type: "WS"} : WS)]},
    {"name": "funcionStatement$ebnf$3", "symbols": ["funcionStatement$ebnf$3", "funcionStatement$ebnf$3$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    ...
    {"name": "funcionStatement$ebnf$4$subexpression$1", "symbols": [(lexer.has("NL") ? {type: "NL"} : NL)]},
    {"name": "funcionStatement$ebnf$4$subexpression$1", "symbols": [(lexer.has("WS") ? {type: "WS"} : WS)]},
    {"name": "funcionStatement$ebnf$4", "symbols": ["funcionStatement$ebnf$4", "funcionStatement$ebnf$4$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    ...
    {"name": "funcionStatement$ebnf$6$subexpression$1", "symbols": [(lexer.has("NL") ? {type: "NL"} : NL)]},
    {"name": "funcionStatement$ebnf$6$subexpression$1", "symbols": [(lexer.has("WS") ? {type: "WS"} : WS)]},
    {"name": "funcionStatement$ebnf$6", "symbols": ["funcionStatement$ebnf$6", "funcionStatement$ebnf$6$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    ...
    {"name": "declaracion", "symbols": [{"literal":"entero"}, "declaracion$subexpression$1", "variable", "declaracion$subexpression$2", {"literal":"<<<"}, "declaracion$subexpression$3", (lexer.has("number") ? {type: "number"} : number), "findelinea"], "postprocess": (d) => 'let '+d[2]+' = '+d[6]+''},
    ...
    {"name": "declaracion", "symbols": [{"literal":"logico"}, "declaracion$subexpression$4", "variable", "declaracion$subexpression$5", {"literal":"<<<"}, "declaracion$subexpression$6", "declaracion$subexpression$7", "findelinea"], "postprocess": (d) => 'let '+d[2]+' = '+d[6]+''},
    ...
    {"name": "declaracion", "symbols": ["declaracion$subexpression$8", "declaracion$subexpression$9", "variable", "declaracion$subexpression$10", {"literal":"<<<"}, "declaracion$subexpression$11", "declaracion$subexpression$12", "findelinea"], "postprocess": (d) => 'let '+d[2]+' = '+d[6]+''},
