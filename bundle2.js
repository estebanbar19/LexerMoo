...
var grammar = {
    ...
    {"name": "bloquecodigo", "symbols": [(lexer.has("lbracket") ? {type: "lbracket"} : lbracket), {"literal":"statement"}, (lexer.has("rbracket") ? {type: "rbracket"} : rbracket)], "postprocess": id}
]
  , ParserStart: "bloquecodigo"
}
